...
print("Height of the ball at", int(t), "second =", calculate_height(t), "meters")
...
def calculate_car_distance(time):
    ...
    # TODO: Implement this function
print("The car will travel", int(calculate_car_distance(time)), "meters in", int(time), "seconds.")
